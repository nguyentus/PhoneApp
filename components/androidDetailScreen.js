...
export default class IphoneDetailScreen extends Component{  
    static navigationOptions = ({ navigation }) => {
        return {
            title: navigation.state.params.Android.Ten,
            headerStyle: {
    ...
    constructor(props){
        super(props);
        let Android = this.props.navigation.state.params.Android;
        this.state={
            Ma_so:Android.Ma_so,
            Ten:Android.Ten,
            Hinh:'https://servicedatajs.herokuapp.com/' + Android.Ma_so + '.png',            
            Don_gia_Ban:Android.Don_gia_Ban
        }
    }
